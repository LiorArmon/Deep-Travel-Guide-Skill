---
name: deep-travel-guide
description: "Generate deeply researched, beautifully curated travel guides with expert planning, local insight, practical advice, and thoughtful editorial judgment. Delivers a finished Word (.docx) document. More travel book than itinerary."
---
...
Rather than one large history chapter, weave short contextual callouts — history, architecture, engineering, geology, ecology, religion, literature, notable art or artists, local customs, or a place's appearance in a book or film — exactly where they deepen the traveler's experience, concise and directly connected to the place rather than turning the guide into a textbook.
...
**Every rating carries its justification in the same breath, not a separate paragraph.** A star rating without a reason is decoration — it asks the traveler to trust it rather than letting them evaluate it. State it as one clause attached to the name, not a bare label: not "★★★ Fushimi Inari," but "★★★ Fushimi Inari — one of the few iconic places that genuinely lives up to its reputation if you arrive before sunrise." This is the same why-this-why-here-why-now standard from Editorial Standards, just made visible right where the rating appears rather than left implicit.
...
Before producing the document, review the guide as though preparing it for publication. Confirm: the structure fits the destination; recommendations feel curated, not exhaustive; logistics are realistic; pacing is comfortable; length matches the calibration guidance; accommodation supports the intended experience; budgeting reflects verified priorities; booking advice reflects current realities; practical advice improves the trip; contextual callouts land where they add value; writing is concise and consistent; every named place, price, or claim was verified, generalized, or flagged. Check whether any stop's history, design, engineering, or art is rich enough to deserve a context box — a building's design story, a museum's notable works and what to notice in them, a place's appearance in a book or film. If none appear anywhere in the guide, verify that's genuinely correct for this trip, not an oversight.
